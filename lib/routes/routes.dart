...
Map<String, WidgetBuilder> routes = {
  ...
  WishListRoute.config.routePath: WishListRoute.routeBuilder,
  AddWishItemRoute.config.routePath: AddWishItemRoute.routeBuilder,
  AddWishPaymentRoute.config.routePath: AddWishPaymentRoute.routeBuilder,
};
